...
export const allowedAttachmentTypes = ["text/plain", "application/json", "image/png", "image/jpeg"] as const;
...
export function decodeAttachment(input: { name: string; type: AllowedAttachmentType; dataBase64: string }): DecodedAttachment {
